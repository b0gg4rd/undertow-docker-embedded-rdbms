 ...
 */
public class UndertowDockerEmbeddedRdbmsApplication {
  ...
  private static final Logger LOGGER = LogManager.getLogger(UndertowDockerEmbeddedRdbmsApplication.class);

  public static void main(final String[] args) throws Exception {

    try (final var inputStream = UndertowDockerEmbeddedRdbmsApplication.class.getResourceAsStream(APPLICATION_PROPERTIES)) {
    ...
    LOGGER.info("{} started for interface {} and port {}", UndertowDockerEmbeddedRdbmsApplication.class.getSimpleName(),
                                                           APPLICATION.getProperty(HOST),
